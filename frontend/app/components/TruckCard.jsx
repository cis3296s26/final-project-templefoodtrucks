...
export default function TruckCard({truckName}){
    ...
    return (
        <>
        <div className="bg-blue-500 mb-4 w-3/12 rounded-4xl border-4 m-4 overflow-hidden hover:scale-105 hover:shadow-xl transition-all duration-300"> {/* This is to stylize the content and the individual card */}
